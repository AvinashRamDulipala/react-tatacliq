...
this.setState({
searchData : result.searchresult,loading: false});
}.bind(this))
...
for(var product in this.state.searchData)
   {
      if (this.state.searchData.hasOwnProperty(product))
      {
            ...
            productData.push(
<Product product={this.state.searchData[product]} key={this.state.searchData[product].productId+ Math.random()}></Product>);
                ...
                <div id="nav-top-icons" className="nav-header-body">
                  <div className="nav-header-body-left-icon">
                    <div className="icon-position" style={{width: '16px', height:'16px'}}>
                      <div className="icon-left" style={{backgroundImage: 'url(https://tmppprd.tataunistore.com/static/media/arrowBack.1607a455.svg)',backgroundSize: 'contain'}}></div>
                    </div>
                  </div>
                  <div className="logo">
                    <div className="icon-position" style={{width: '35px', height:'45px'}}>
                      <div className="navbar-header-icon" style={{backgroundImage: 'url(https://tmppprd.tataunistore.com/static/media/group.ccb1a969.svg)', backgroundSize: 'contain'}}></div>
                    </div>
                  </div>
                  <div className="search-icon">
                    <div className="icon-position" style={{width: '16px', height:'16px'}}>
                      <div className="navbar-header-icon" onClick={this.searchOpen} style={{backgroundImage: 'url(https://tmppprd.tataunistore.com/static/media/search.a4309640.svg)', backgroundSize: 'contain'}}></div>
                    </div>
                  </div>
                ...
                <div className="navbar navbar-default">
                  <div className="navbar-header">
                    <div id="nav-top-icons" className="nav-header-body">
                      <div className="search-icon">
                        <div className="icon-position"style={{width: '16px', height:'16px'}}>
                          <div className="navbar-header-icon" onClick={this.searchClose} style={{backgroundImage: 'url(https://tmppprd.tataunistore.com/static/media/cancel.fea9f12f.svg)', backgroundSize: 'contain'}}></div>
                        </div>
                      </div>
                      <div className="input-search">
                        <div className="input-search-text">
                          <div className="icon-position" style={{width: '16px', height:'45px'}}>
                            <div className="navbar-header-icon" style={{backgroundImage: 'url(https://tmppprd.tataunistore.com/static/media/searchwhite.8af840bd.svg)', backgroundSize: 'contain'}}></div>
                          </div>
                        </div>
