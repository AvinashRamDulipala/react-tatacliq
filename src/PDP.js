    ...
    for(var prop in this.state.productImages)
       {
          ...
          {
                 productDetails.push(
  <img key={this.state.productImages[prop]} src={this.state.productImages[prop]} alt="Shirts"/>);


          }
      }
  return(
  <div id="root" ref="someRef"  className="parent"   >
              ...
              <div className="brand-details">
                <div >
                  <h2 className="product-brand-name">
                    <span >{this.state.productData.brandName}</span>
                  </h2>
                </div>
          ...
          <Then>
            ...
            <div className="product-variations">
              <div className="product-variations-options" >
                <div className="product-variations-color">Colour: 
                  <span >{this.state.productData.variantOptions ? this.state.productData.variantOptions[0].colorlink.color : ''}</span>
                </div>
   ...
   this.state.variantOptions.map(function(post, index){
        ...
        <div className="product-seller-name">
          <div className="product-seller-winning-seller">
            <div className="product-sold-by">Sold by 
              <span className="span-sold-by">{this.state.productData.winningSellerName }</span>
            </div>
          </div>
        </div>
